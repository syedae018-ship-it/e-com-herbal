        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sage-100 border border-sage-200/60 text-forest-900 text-xs font-semibold tracking-wide">
              ...
              <span>Organic & Herbal Everyday Care</span>
            </div>

            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-extrabold text-forest-950 tracking-tight leading-[1.15]">
              Natural Care, the <br className="hidden sm:inline" />
              <span className="text-forest-700 italic font-normal">Botanical Way.</span>
            </h1>

            <p className="text-sm sm:text-base text-charcoal-700 max-w-xl mx-auto lg:mx-0 leading-relaxed font-sans">
              Thoughtfully formulated organic soaps, pure hair oils, botanical cleansers, and body essentials. Handcrafted with traditional Indian herbs and zero harsh chemicals.
            </p>
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/5] rounded-3xl overflow-hidden shadow-elevated border-8 border-white bg-sand-100">
              <Image
                src="https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?auto=format&fit=crop&w=1000&q=85"
                alt="Herbal E Com Life Handcrafted Botanical Soap and Body Care"
                fill
                priority
              ...
              <div className="absolute bottom-5 left-5 right-5 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-sand-200 shadow-card flex items-center justify-between">
                <div className="space-y-0.5">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-sage-600">Handmade Botanical Bar</span>
                  <p className="font-serif font-bold text-xs sm:text-sm text-forest-950">Neem & Tulsi Herbal Soap</p>
                  <p className="text-xs font-bold text-forest-800">₹149 <span className="text-[11px] text-charcoal-400 line-through">₹199</span></p>
                </div>
                <Link
                  href="/product/neem-tulsi-herbal-soap"
